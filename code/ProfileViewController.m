...
-(void)reloadUserData
{
    //session = [C4FSession sharedInstance];
...
- (IBAction)getTheMoney:(id)sender 
{
    ...
    if ([[dict objectForKey:@"success"] intValue] == 1) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"C4F" message:@"Request for money transfer successuflly!" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
