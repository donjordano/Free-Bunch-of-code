//
//  ConfirmRegistratonVIewController.m
//  C4F
//
...
{
    [super viewDidLoad];
    howToStrings = [NSArray arrayWithObjects: @"Proceed to Log In", 
                    @"I didn't get email!", nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [howToStrings objectAtIndex:indexPath.row];
